...
# This collection of classes lets me call something like compass.east to get 90 degrees
# Need to make inverse for decoding bearing decimal after using _get_baring(lat,long)
...
class CompassComplex:
    ...
    compass["northeast by north"] = compass[
        "NEbN"
    ] = northeast_by_north = NEbN = CompassPoint(
        "northeast by north",
        "NEbN",
    ...
    compass["northeast by east"] = compass[
        "NEbE"
    ] = northeast_by_east = NEbE = CompassPoint(
        "northeast by east",
        "NEbE",
    ...
    compass["southeast by east"] = compass[
        "SEbE"
    ] = southeast_by_east = SEbE = CompassPoint(
        "southeast by east",
        "SEbE",
    ...
    compass["southeast by south"] = compass[
        "SEbS"
    ] = southeast_by_south = SEbS = CompassPoint(
        "southeast by south",
        "SEbS",
    ...
    compass["southwest by south"] = compass[
        "SWbS"
    ] = southwest_by_south = SWbS = CompassPoint(
        "southwest by south",
        "SWbS",
    ...
    compass["southwest by west"] = compass[
        "SWbW"
    ] = southwest_by_west = SWbW = CompassPoint(
        "southwest by west",
        "SWbW",
    ...
    compass["northwest by west"] = compass[
        "NWbW"
    ] = northwest_by_west = NWbW = CompassPoint(
        "northwest by west",
        "NWbW",
    ...
    compass["northwest by north"] = compass[
        "NWbN"
    ] = northwest_by_north = NWbN = CompassPoint(
        "northwest by north",
        "NWbN",
